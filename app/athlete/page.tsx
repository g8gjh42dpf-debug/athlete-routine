  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0a0a0f', color:'#f0f0f5', fontFamily:"'DM Sans', sans-serif" }}>
      ...
      <nav style={{ position:'fixed', top:0, left:0, right:0, zIndex:100, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 16px', background:'rgba(10,10,15,0.9)', backdropFilter:'blur(20px)', borderBottom:'1px solid rgba(255,255,255,0.06)', boxSizing:'border-box' }}>
        ...
        <div style={{ width:40, height:40, flexShrink:0, paddingRight:4 }}>
          <button onClick={() => handleTabChange('profil')} style={{ width:36, height:36, borderRadius:'50%', background:`linear-gradient(135deg, #f96167, #f5a623)`, border:'2px solid rgba(255,255,255,0.15)', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:"'Bebas Neue', sans-serif", fontSize:15, color:'#fff', letterSpacing:0, transition:'transform 0.2s', outline:'none' }}>
